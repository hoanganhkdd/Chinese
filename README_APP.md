...
| 🌿 **Bộ thủ** | **Đủ 214 bộ thủ Khang Hy** (256 khóa) **xếp theo độ phổ biến** (#1 = hay gặp nhất), **highlight 🔥** top 10/30/60. Chi tiết mỗi bộ: hạng + phân tích + chữ mang bộ (bấm xem chiết tự/cách nhớ) + từ liên quan trong kho. |
