...
const RADICALS = {
  ...
  "二":{hv:"NHỊ",m:"hai"},
  "亠":{hv:"ĐẦU",m:"nét đầu (trên)",ex:"京 亮 高 交 市 夜"},
  "人":{hv:"NHÂN",m:"người",ex:"从 众 今 会 全 介 命"},
  "亻":{hv:"NHÂN",m:"người",ex:"你 他 们 什 件 住 位 但 做 假"},
  "儿":{hv:"NHÂN",m:"người (chân)",ex:"元 兄 光 先 兆"},
  "入":{hv:"NHẬP",m:"vào",ex:"内 全"},
  "八":{hv:"BÁT",m:"tám; chia",ex:"分 公 兰 关 兴"},
  "冂":{hv:"QUYNH",m:"vùng biên"},
  "冖":{hv:"MỊCH",m:"trùm khăn",ex:"写 军 冠 农"},
  "冫":{hv:"BĂNG",m:"băng, nước đá",ex:"冰 冷 冻 凉 准 净"},
  "几":{hv:"KỶ",m:"ghế nhỏ"},
  "凵":{hv:"KHẢM",m:"há miệng"},
  "刀":{hv:"ĐAO",m:"dao",ex:"分 切 券 剪"},
  "刂":{hv:"ĐAO",m:"dao",ex:"到 前 别 刻 剧 利"},
  "力":{hv:"LỰC",m:"sức mạnh",ex:"办 加 动 助 努 男 劳"},
  "勹":{hv:"BAO",m:"bao bọc",ex:"包 句 匀 勺 够"},
  "匕":{hv:"CHỦY",m:"thìa, muỗng"},
  "匚":{hv:"PHƯƠNG",m:"hộp vuông",ex:"区 医 匠 匹"},
  "匸":{hv:"HỆ",m:"che đậy"},
  "十":{hv:"THẬP",m:"mười"},
  "卜":{hv:"BỐC",m:"bói toán"},
  "卩":{hv:"TIẾT",m:"dấu, đốt",ex:"印 却 卫 危 卷"},
  "厂":{hv:"HÁN",m:"sườn núi",ex:"厅 历 厚 原 厉 压"},
  "厶":{hv:"KHƯ",m:"riêng tư"},
  "又":{hv:"HỰU",m:"lại; tay phải",ex:"友 双 反 发 取 受 叔"},
  ...
  "子":{hv:"TỬ",m:"con",ex:"孩 学 字 孙 孝"},
  "宀":{hv:"MIÊN",m:"mái nhà",ex:"家 客 完 宝 定 安 室 宿 容"},
  "寸":{hv:"THỐN",m:"tấc",ex:"对 封 射 尊"},
  ...
  "巛":{hv:"XUYÊN",m:"sông"},
  "川":{hv:"XUYÊN",m:"sông"},
  "工":{hv:"CÔNG",m:"công việc",ex:"左 巧 差 攻"},
  "己":{hv:"KỶ",m:"mình, bản thân"},
  "巾":{hv:"CÂN",m:"khăn"},
  "干":{hv:"CAN",m:"can; khiên",ex:"平 年 幸"},
  "幺":{hv:"YÊU",m:"nhỏ bé"},
  "广":{hv:"NGHIỄM",m:"mái hiên",ex:"店 床 座 应 底 度"},
  "廴":{hv:"DẪN",m:"bước dài"},
  "廾":{hv:"CỦNG",m:"chắp tay"},
  "弋":{hv:"DỰC",m:"bắn; cọc"},
  "弓":{hv:"CUNG",m:"cây cung",ex:"张 弹 强 弯 引 弟"},
  "彐":{hv:"KÝ",m:"đầu con nhím"},
  "彡":{hv:"SAM",m:"lông, tia",ex:"形 影 参 须"},
  "彳":{hv:"XÍCH",m:"bước ngắn",ex:"很 得 往 律 徐 街"},
  "心":{hv:"TÂM",m:"tim, lòng",ex:"想 念 感 意 思 忘 志 急 怒"},
  "忄":{hv:"TÂM",m:"tim, lòng",ex:"忙 快 慢 怕 情 惯 懂 忆"},
  "戈":{hv:"QUA",m:"giáo mác",ex:"我 战 成 或 划 找"},
  "戶":{hv:"HỘ",m:"cửa một cánh"},
  "户":{hv:"HỘ",m:"cửa một cánh",ex:"房 所 扇 启"},
  "手":{hv:"THỦ",m:"tay",ex:"掌 拳 摩"},
  "扌":{hv:"THỦ",m:"tay",ex:"打 拿 找 提 把 推 拉 接 换 掉"},
  "支":{hv:"CHI",m:"cành, chi"},
  "攴":{hv:"PHỘC",m:"đánh khẽ"},
  "攵":{hv:"PHỘC",m:"đánh khẽ",ex:"收 改 教 政 数 敏"},
  "文":{hv:"VĂN",m:"văn, chữ"},
  "斗":{hv:"ĐẨU",m:"cái đấu (đong)"},
  "斤":{hv:"CÂN",m:"cái rìu; cân",ex:"新 断 折 斯"},
  "方":{hv:"PHƯƠNG",m:"vuông; phương",ex:"放 旅 族 旗"},
  "无":{hv:"VÔ",m:"không"},
  ...
  "欠":{hv:"KHIẾM",m:"thiếu; ngáp",ex:"欢 歌 次 欧 歇 款"},
  "止":{hv:"CHỈ",m:"dừng",ex:"正 步 歧 武"},
  "歹":{hv:"ĐÃI",m:"xấu; chết"},
  "殳":{hv:"THÙ",m:"binh khí"},
  "毋":{hv:"VÔ",m:"chớ, đừng"},
  "比":{hv:"TỶ",m:"so sánh"},
  "毛":{hv:"MAO",m:"lông",ex:"毫 毯 尾"},
  "氏":{hv:"THỊ",m:"họ (tên họ)"},
  "气":{hv:"KHÍ",m:"hơi, khí",ex:"氧 氢 氛"},
  "水":{hv:"THỦY",m:"nước"},
  "氵":{hv:"THỦY",m:"nước",ex:"河 海 湖 江 洗 汉 酒 没 游 清"},
  "火":{hv:"HỎA",m:"lửa",ex:"烧 烤 灯 炒 烟 灾"},
  "灬":{hv:"HỎA",m:"lửa",ex:"点 热 然 照 熊"},
  "爪":{hv:"TRẢO",m:"móng vuốt",ex:"爬 爱 采 爵"},
  "爫":{hv:"TRẢO",m:"móng vuốt"},
  "父":{hv:"PHỤ",m:"cha",ex:"爸 爷 斧"},
  "爻":{hv:"HÀO",m:"hào (quẻ)"},
  "爿":{hv:"TƯỜNG",m:"mảnh gỗ trái"},
  "片":{hv:"PHIẾN",m:"tấm, mảnh",ex:"版 牌"},
  "牙":{hv:"NHA",m:"răng",ex:"芽 穿"},
  "牛":{hv:"NGƯU",m:"trâu bò",ex:"物 特 牧 牲"},
  "牜":{hv:"NGƯU",m:"trâu bò"},
  "犬":{hv:"KHUYỂN",m:"chó"},
  ...
  "瓜":{hv:"QUA",m:"quả dưa"},
  "瓦":{hv:"NGÕA",m:"ngói",ex:"瓶 瓷"},
  "甘":{hv:"CAM",m:"ngọt",ex:"甜 某 甚"},
  "生":{hv:"SINH",m:"sinh, sống",ex:"性 姓 星 牲"},
  "用":{hv:"DỤNG",m:"dùng",ex:"甩 甫"},
  "田":{hv:"ĐIỀN",m:"ruộng",ex:"男 界 留 略 番"},
  "疋":{hv:"THẤT",m:"vải; chân"},
  "疒":{hv:"NẠCH",m:"bệnh",ex:"病 疼 痛 疯 瘦 疫"},
  "癶":{hv:"BÁT",m:"đôi chân gạt ngược"},
  "白":{hv:"BẠCH",m:"trắng",ex:"百 的 泉 皂"},
  "皮":{hv:"BÌ",m:"da",ex:"皱 破 波"},
  "皿":{hv:"MÃNH",m:"bát đĩa",ex:"盘 盆 盒 盖 盐 盛"},
  "目":{hv:"MỤC",m:"mắt",ex:"看 眼 睡 睛 眠"},
  "矛":{hv:"MÂU",m:"cây giáo",ex:"柔 茅"},
  "矢":{hv:"THỈ",m:"mũi tên",ex:"知 短 矮"},
  "石":{hv:"THẠCH",m:"đá",ex:"矿 码 硬 碰 确 碗"},
  "示":{hv:"THỊ",m:"thần; chỉ bảo",ex:"票 禁 祭"},
  "礻":{hv:"THỊ",m:"thần; chỉ bảo",ex:"祝 神 祖 福 礼 社 视"},
  "禸":{hv:"NHỮU",m:"vết chân thú"},
  "禾":{hv:"HÒA",m:"lúa",ex:"和 秋 种 科 秒 税"},
  "穴":{hv:"HUYỆT",m:"hang",ex:"空 穿 突 窗 究 窄"},
  "立":{hv:"LẬP",m:"đứng",ex:"站 端 竞 章 亲"},
  "竹":{hv:"TRÚC",m:"tre",ex:"笑 笔 笨 答 篮 简 筷"},
  "米":{hv:"MỄ",m:"gạo",ex:"料 粉 精 糖 粥"},
  "糸":{hv:"MỊCH",m:"sợi tơ"},
  "纟":{hv:"MỊCH",m:"sợi tơ",ex:"红 给 经 线 纸 结 组 练"},
  "缶":{hv:"PHẪU",m:"vò sành"},
  "网":{hv:"VÕNG",m:"lưới",ex:"罗 罚 罪 置 署"},
  "罒":{hv:"VÕNG",m:"lưới",ex:"罗 罚 罪 置 署"},
  "羊":{hv:"DƯƠNG",m:"dê cừu",ex:"样 洋 鲜 群 美 差"},
  "羽":{hv:"VŨ",m:"lông vũ",ex:"翅 翻 翁"},
  "老":{hv:"LÃO",m:"già",ex:"考 者 孝"},
  "耂":{hv:"LÃO",m:"già",ex:"考 者 孝"},
  "而":{hv:"NHI",m:"mà; râu",ex:"需 耍"},
  "耒":{hv:"LỖI",m:"cái cày"},
  ...
  "至":{hv:"CHÍ",m:"đến"},
  "臼":{hv:"CỰU",m:"cối giã"},
  "舌":{hv:"THIỆT",m:"lưỡi",ex:"话 甜 乱 舔"},
  "舛":{hv:"SUYỄN",m:"ngang trái"},
  "舟":{hv:"CHU",m:"thuyền",ex:"船 航 般 舰"},
  "艮":{hv:"CẤN",m:"dừng; quẻ Cấn"},
  "色":{hv:"SẮC",m:"màu sắc",ex:"艳"},
  "艸":{hv:"THẢO",m:"cỏ, cây"},
  "艹":{hv:"THẢO",m:"cỏ, cây",ex:"花 草 茶 菜 药 苦 苹 落 蓝"},
  "虍":{hv:"HÔ",m:"vằn hổ"},
  "虫":{hv:"TRÙNG",m:"sâu bọ",ex:"蚊 蛇 蜂 虾 蝶"},
  "血":{hv:"HUYẾT",m:"máu",ex:"衅"},
  "行":{hv:"HÀNH",m:"đi; hàng",ex:"街 衡 衍"},
  "衣":{hv:"Y",m:"áo",ex:"表 装 裁 裂"},
  "衤":{hv:"Y",m:"áo",ex:"衬 补 被 裤 袜"},
  "襾":{hv:"Á",m:"che đậy"},
  "見":{hv:"KIẾN",m:"thấy"},
  "见":{hv:"KIẾN",m:"thấy",ex:"观 觉 视 规 览"},
  "角":{hv:"GIÁC",m:"sừng; góc",ex:"解 触"},
  "言":{hv:"NGÔN",m:"lời nói",ex:"警 誉 誓"},
  "讠":{hv:"NGÔN",m:"lời nói",ex:"说 话 语 请 谢 课 认 识 读 谁"},
  "谷":{hv:"CỐC",m:"thung lũng",ex:"欲 容"},
  "豆":{hv:"ĐẬU",m:"đậu; bát đậu",ex:"逗 登 短"},
  "豕":{hv:"THỈ",m:"con lợn",ex:"家 象 豪"},
  "豸":{hv:"TRĨ",m:"thú không chân"},
  "貝":{hv:"BỐI",m:"vỏ sò; tiền của"},
  "贝":{hv:"BỐI",m:"vỏ sò; tiền của",ex:"贵 费 买 卖 财 货 赢 贷"},
  "赤":{hv:"XÍCH",m:"đỏ"},
  "走":{hv:"TẨU",m:"chạy",ex:"起 越 超 趣 赴"},
  "足":{hv:"TÚC",m:"chân",ex:"跑 跳 路 踢 跟 距"},
  "身":{hv:"THÂN",m:"thân mình",ex:"躺 躲 射"},
  "車":{hv:"XA",m:"xe"},
  "车":{hv:"XA",m:"xe",ex:"轮 转 软 较 辆"},
  "辛":{hv:"TÂN",m:"cay; can Tân",ex:"辣 辜 辨"},
  "辰":{hv:"THẦN",m:"chi Thìn; sớm",ex:"晨 农 唇 震"},
  "辵":{hv:"SƯỚC",m:"bước đi"},
  "辶":{hv:"SƯỚC",m:"bước đi",ex:"这 边 过 进 远 近 送 通 道 迎"},
  "邑":{hv:"ẤP",m:"làng (bên phải)"},
  "阝":{hv:"ẤP",m:"làng (bên phải)",ex:"院 阳 除 队 都 部 陪"},
  "酉":{hv:"DẬU",m:"rượu; chi Dậu",ex:"酒 醒 醉 配 酸 醋"},
  "釆":{hv:"BIỆN",m:"phân biệt"},
  "里":{hv:"LÝ",m:"dặm; làng",ex:"野 量 重"},
  "金":{hv:"KIM",m:"kim loại, vàng",ex:"鑫 鉴"},
  ...
  "隶":{hv:"ĐÃI",m:"bắt kịp"},
  "隹":{hv:"CHUY",m:"chim đuôi ngắn",ex:"难 谁 集 售 雄 雕"},
  "雨":{hv:"VŨ",m:"mưa",ex:"雪 需 雷 零 雾 震"},
  "青":{hv:"THANH",m:"xanh",ex:"静 靖"},
  "非":{hv:"PHI",m:"không; trái",ex:"靠 悲 罪"},
  "面":{hv:"DIỆN",m:"mặt"},
  "革":{hv:"CÁCH",m:"da thuộc",ex:"鞋 鞭 靴"},
  "韋":{hv:"VI",m:"da mềm"},
  "韦":{hv:"VI",m:"da mềm"},
  "韭":{hv:"CỬU",m:"rau hẹ"},
  "音":{hv:"ÂM",m:"âm thanh",ex:"意 章 韵"},
  ...
  "首":{hv:"THỦ",m:"đầu",ex:"道"},
  "香":{hv:"HƯƠNG",m:"mùi thơm",ex:"馨"},
  "馬":{hv:"MÃ",m:"ngựa"},
  "马":{hv:"MÃ",m:"ngựa",ex:"骑 驾 骂 妈 闯 骗"},
  "骨":{hv:"CỐT",m:"xương",ex:"骼"},
  "高":{hv:"CAO",m:"cao",ex:"稿"},
  "髟":{hv:"BƯU",m:"tóc dài"},
  "鬥":{hv:"ĐẤU",m:"đánh nhau"},
  "鬯":{hv:"SƯỞNG",m:"rượu nếp"},
  "鬲":{hv:"CÁCH",m:"nồi ba chân"},
  "鬼":{hv:"QUỶ",m:"ma quỷ",ex:"魂 魔 魅"},
  "魚":{hv:"NGƯ",m:"cá"},
  ...
  "麦":{hv:"MẠCH",m:"lúa mạch",ex:"麸"},
  "麻":{hv:"MA",m:"cây gai",ex:"摩 磨 魔"},
  "黃":{hv:"HOÀNG",m:"vàng"},
  "黄":{hv:"HOÀNG",m:"vàng"},
  "黍":{hv:"THỬ",m:"lúa nếp"},
  "黑":{hv:"HẮC",m:"đen",ex:"墨 默"},
